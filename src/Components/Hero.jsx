...
const Hero = () => {
  ...
  return  ( <div className="w-full h-[550px] lg:h-[850px]">
      <div className="w-full h-full">
        <div className="absolute w-full h-[550px] lg:h-[850px] ng-gradient-to-r from-black " />
          <img
          className="s-full h-full object-cover object-top" 
